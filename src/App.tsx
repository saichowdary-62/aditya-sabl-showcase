...
const App = () => {
  // Optimization: Removed artificial 3000ms delay and loading state.
  // We use Suspense with PageLoader to show loading only when strictly necessary during chunk loading.
